module NetSuite
  module Records
    # Beware of possible gotcha when closing sales order. You need to set the
    ...
    class SalesOrderItem
      ...
      fields :amount, :bin_numbers, :cost_estimate, :cost_estimate_type, :defer_rev_rec, :description, :gift_cert_from,
        ...
        :line, :order_line, :po_currency, :quantity, :quantity_billed, :rate, :rev_rec_end_date, :rev_rec_start_date, :rev_rec_term_in_months,
